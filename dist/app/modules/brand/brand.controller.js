...
const createBrand = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield brand_service_1.BrandService.createBrand(user, store_id, payload, file);
...
const getAllBrands = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pick_1.default)(req.query, brand_constant_1.BRAND_FILTERS_FIELDS);
    const result = yield brand_service_1.BrandService.getAllBrands(user, store_id, options, filters);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const getSingleBrand = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield brand_service_1.BrandService.getSingleBrand(user, params);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const updateBrand = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const payload = req.body;
    const file = req === null || req === void 0 ? void 0 : req.file;
    const result = yield brand_service_1.BrandService.updateBrand(user, params, payload, file);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const deleteBrand = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const params = (0, pick_1.default)(req.params, store_id_1.PARAMS_STORE_ID);
    const result = yield brand_service_1.BrandService.deleteBrand(user, params);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
        message: 'Brand successfully deleted',
